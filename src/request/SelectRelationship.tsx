...
import { ChevronLeft, Heart, Users, Briefcase, Star, UserPlus, Sparkles } from 'lucide-react'
...
const relationshipGroups: { title: string; options: RelationshipOption[] }[] = [
    {
        title: 'Family',
        options: [
    ...
    return (
        <div className="request-page">
            ...
            <header className="request-header">
                ...
                <span className="request-title">Relationship</span>
