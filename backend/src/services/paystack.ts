 ...
 *
 * Paystack API: POST /customer/deactivate_authorization
 * https://paystack.com/docs/api/customer/#deactivate-authorization
 */
export async function deactivateAuthorization(authorizationCode: string): Promise<boolean> {
  try {
    ...
    // Log but don't throw - authorization might already be deactivated
